	...
	$(".add-dsxx").click(function(){
		$(".dszl").append(
				'<option value='+"0"+'>'
						+ "请选择"
						+ '</option>')
		$('.addds').append('<li class="edittable-middle"><div class="editmiddle-left">毒素信息</div><div class="editmiddle-right"><ul><li><lable>毒素种类</lable><select name="toxinId" class="dszl" ><option value="0" >请选择</option></select><span class="toxin_id" ></span></li><li><lable>毒素含量</lable><input name="toxinCount" type="text" class="toxin_id1"   maxlength="10" placeholder="毒素含量最大可输入十位"/><span class="toxin_count" ></span></li><li><a class="del">删除</a></li></ul></div></li>')
		//alert(1);
//		$.ajax({
//			url:"addtextoption",
//			type:"post",
